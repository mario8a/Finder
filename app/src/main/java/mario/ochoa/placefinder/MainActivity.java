...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private static final String CLOUD_VISION_API_KEY = "AIzaSyB1Vlx0q359d3Pd60TWkeYrQcuMenlMO6M";

    @BindView(R.id.TomarFoto)
    Button tomarFoto;
    ...
    private String[] visionAPI = new String[]{"IMAGE_DETECTION"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        siguiente = (Button)findViewById(R.id.buscar);
        webvieww = (Button)findViewById(R.id.buscar2);

        siguiente.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent siguiente = new Intent(MainActivity.this, Informacion.class);
                startActivity(siguiente);
            }
        });

        webvieww.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent sigue = new Intent(MainActivity.this,WebView.class);
                startActivity(sigue);
            }
        });
